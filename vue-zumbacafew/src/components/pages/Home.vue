<template>
  <div>
    ...
    <div class="container inter-text annotation">
      <p>
        Vous avez toujours voulu savoir si le vocabulaire d'un rappeur était plus riche que celui d'un autre ? Si le rap
        c'était mieux avant ? Si le vocabulaire de <a href="https://genius.com/artists/Booba">Booba</a> est plus riche
        que celui de <a href="https://genius.com/artists/Kaaris">Kaaris</a> ?
      </p>
      <p>
    ...
    <div class="container inter-text annotation">
      <p>
        ...
        populaires. Les artistes qui n'atteignent pas ce seuil sont précisés via une annotation.
      </p>
      <p>
        Le graphique permet de filtrer les artistes selon leur <strong>sexe</strong>, s'il s'agit <strong>d'un groupe ou
          d'un artiste solo</strong> et <strong>l'année</strong> de celui ci.
      </p>
      <p>
        La décennie à laquelle appartient chaque artiste est calculée à partir de la moyenne de ses musiques les plus
        populaires.
      </p>
    </div>
    ...
    <div class="container inter-text annotation">
      <p>
        Ce graphique présente une autre vue du premier graphique. Chaque artistes est disposé dans une collonne en
        fonction de la richesse de son vocabulaire
      </p>
    </div>
    <hr class="annotation-separator">
    <div class="container inter-text annotation">
      <p>
        Vous voulez découvrir quels sont les mots les plus fréquents dans le rap français ? Quel termes sont les plus
        utilisés par un artiste ? Si le mot le plus utilisé par <a href="https://genius.com/artists/Wejdene">Wejdene</a>
        est Coco ?
      </p>
      <p>
