        ...
        <div class="container">
            ...
            <span id="criterion-container">
                ...
                <div class="form-check">
                    <input class="form-check-input" type="radio" name="radio-word-histogram" id="radio-year" value="year" checked>
                ...
                <div class="form-check">
                    <input class="form-check-input" type="radio" name="radio-word-histogram" id="radio-artist-type" value="artist_type">
...
export default {
  ...
  methods:{
    ...
    applyFilter(criterion){
        if(criterion != "year"){
            let criterionValues = Array.from(new Set(this.artistsStats.map(x => x[criterion])))
            ...
            let criterionValues = Array.from(new Set(this.artistsStats.map(x => Helper.ceilYear(x[criterion]))))
